...
Please report vulnerabilities privately through GitHub Security Advisories once the repository is published, or by contacting the maintainers listed by the project owner. Do not open public issues for vulnerabilities involving credential leakage, prompt/report injection, unsafe data handling, or benchmark data exfiltration.
...
- Keep benchmark corpora and enterprise exports outside version control.
...
- Markdown reports escape dataset-controlled fields to reduce report injection risk.
